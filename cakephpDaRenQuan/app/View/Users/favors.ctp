	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<div class="user-top-menu">
				...
				<a href="/users/favors/<?php echo $user['User']['id']; ?>" class="user-top-submenu active-menu">
		...
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<?php echo getSexTitle($isSelf,$user['User']['sex']);?>的收藏
		       	</div>			       	
	   			<div class="panel-body">
		   			<ul class="media-list">
			   			<?php foreach ($favorArticles as $article): ?>
			   			<li class="media">
							<div class="media-body">
								...
								<small>
								<a href="/users/view/<?php echo $article['Article']['autorid']; ?>">
									<?php echo $article['Article']['autorname']; ?>
								</a>
								&nbsp;&nbsp;
								...
								<?php 
									...
									if ($isSelf){
										$articlId = $article['Article']['id'];
										echo '<a href="/users/unfollowarticle/';
										echo $articlId;
										echo '">';
										echo '取消收藏';
										echo '</a>';
