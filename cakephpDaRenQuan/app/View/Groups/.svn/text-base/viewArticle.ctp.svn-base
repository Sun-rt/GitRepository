	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<div class="group-top-menu">
				...
				<a href="/groups/viewarticle/<?php echo $group['Group']['id']; ?>" class="group-top-submenu active-menu">
		   			...
		   			<ul class="media-list">
			   			...
			   			<li class="media">
							<div class="media-body">
								<div class="col-md-2">
									<img src="<?php echo $article['Article']['thumimageurl'];?>" style="height: 110px; width: 110px;" />
								</div>
								<div class="col-md-10">
							    <a href=<?php echo '/article/view/' . $article['Article']['id']; ?>>
									<h4 class="media-heading" style="margin-top: 8px;margin-bottom: 8px">
										<?php
							    ...
							    <div style="margin-bottom: 15px; margin-top: 12px; height: 42px;">
							    <?php
								$tempTitle = $article['Article']['content'];
								$tempTitle = cut_str($tempTitle, 90, true);
								echo $tempTitle;
								?>
							    </div>
								<small>
