		...
		<div class="col-md-10">
			...
			<div style="margin-top: 5px;">
				<ol class="breadcrumb breadcrumb-arrow">
					...
					<li class="active"><span>编辑活动</span></li>
			    </ol>
			</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="row" onsubmit="return validate_form(this)" method="post" action="/events/edit" enctype="multipart/form-data">
					<textarea name="data[Event][groupid]" style="display: none;">
						<?php echo $group['Group']['id']; ?>
					</textarea>
					<textarea name="data[Event][id]" style="display: none;"><?php echo $event['Event']['id']; ?></textarea>
		   			<div class="row">
			   			...
			   			<div class="col-md-9">
				   			<input type="text" id="title" class="form-control common-control" name="data[Event][title]" placeholder="请输入活动名称" value="<?php echo $event['Event']['title']; ?>">
			   			</div>
		   			</div>
		   			...
		   			<div class="row">
			   			...
			   			<div class="col-md-9">
				   			<div class="input-group date form_datetime col-md-5" data-date-format="yyyy-MM-dd HH:mm:ss" data-link-field="dtp_input1">
					   			<input class="form-control" size="16" type="text" value="<?php echo $event['Event']['begintime']; ?>" name="data[Event][begintime]" readonly>
		   			...
		   			<div class="row" style="margin-top: 10px;">
			   			...
			   			<div class="col-md-9">
				   			<div class="input-group date form_datetime col-md-5" data-date-format="yyyy-MM-dd HH:mm:ss" data-link-field="dtp_input1">
					   			<input class="form-control" size="16" type="text" value="<?php echo $event['Event']['endtime']; ?>" name="data[Event][endtime]" readonly>
					   			<span class="input-group-addon">
					   			<span class="glyphicon glyphicon-th"></span>
					   			</span>
		   			...
		   			<div class="row" style="margin-top: 10px;">
			   			...
			   			<div class="col-md-9">
				   			<div class="input-group date form_datetime col-md-5" data-date-format="yyyy-MM-dd HH:mm:ss" data-link-field="dtp_input1">
					   			<input class="form-control" size="16" type="text" value="<?php echo $event['Event']['applyendtime']; ?>" name="data[Event][applyendtime]" readonly>
					   			<span class="input-group-addon">
					   			<span class="glyphicon glyphicon-th"></span>
					   			</span>
		   			...
		   			<div class="row">
			   			...
			   			<div class="col-md-9">
				   			<input type="text" id="title" class="form-control common-control" name="data[Event][location]" placeholder="请输入地点" value="<?php echo $event['Event']['location']; ?>">
			   			</div>
		   			</div>
		   			...
		   			<div class="row" style="margin-top: 10px;">
			   			...
			   			<div class="col-md-9">
				   			<textarea name="data[Event][content]" type="text/plain" id="myEditor" class="form-control common-control" style="height:600px;width:700px;"><?php echo $event['Event']['content']; ?></textarea>
							<script>
								//实例化编辑器
		   			...
		   			<div class="row" style="margin-top: 10px;">
			   			...
			   			<div class="col-md-9">
							...
							<?php foreach ($categories as $category): ?>
								<?php
								if ($category['EventCategory']['id'] == $event['Category']['id']) {
									echo "<option value=".$category['EventCategory']['id']." selected>";
									echo $category['EventCategory']['name'];
									echo "</option>";
								}
								else
								{
									echo "<option value=".$category['EventCategory']['id'].">";
									echo $category['EventCategory']['name'];
									echo "</option>";
								}
								?>
		   			...
		   			<div class="row" style="margin-top: 15px;">
			   			...
			   			<div class="col-md-9">
							...
							<img id="preview" style="width: 160px; height: 160px;" src="<?php echo $event['Event']['eventimageurl']; ?>" alt="placehold">
			   			</div>
		   			</div>
		   			...
		   			<div class="row" style="margin-top: 15px;">
			   			...
			   			<div class="col-md-9">
				   			<input type="submit" name="submit" value="修改活动" class="btn btn-primary">			   			
			   			</div>
		   			</div>
					</form>
	            </div>
