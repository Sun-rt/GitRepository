<div class="eventCategories index">
	<h2><?php echo __('Event Categories'); ?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ext1'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($eventCategory['EventCategory']['createtime']); ?>&nbsp;</td>
		<td><?php echo h($eventCategory['EventCategory']['ext1']); ?>&nbsp;</td>
		<td class="actions">
